...
<body>
  ...
  <div class="mb-4">
    ...
    <!-- create a NewPassword if User is not remember -->
    <form id="createUserForm" action="{{ route('createNewpasswordPost') }}" method="POST" class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md space-y-6">
    @csrf
    ...
    <a href="#" class="flex justify-center">
        ...
        <button type="submit" class="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500">Submit</button>
    </a>
</form>
