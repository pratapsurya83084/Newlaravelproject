...
<body>
    ...
    <div class='select-none  bg-gray-100 shadow-lg pb-2'>
    ...
    <div class="select-none">
        <div
            class="text-2xl sm:text-4xl md:text-5xl font-bold pt-20  mb-10
       px-5 lg:px-40 text-center ">

            Thank you! <br />
            <h2 class="mt-2">We've successfully received your form.</h2>
            <h2 class="mt-2">You can expect a follow-up from us soon.</h2>
        </div>
        <div class="flex justify-center  mb-20">
            <a href="https://bisjhintus.com/"> <button
                    class="bg-[#009bb5] px-14 py-3 text-2xl
    ...
    <footer class='select-none mb-0 bg-gray-100'>
