...
<body class="font-sans  select-none">
    <div class="flex flex-col h-screen">
        <!-- Logo -->
        <div class="bg-white shadow-md   flex justify-center py-2">
        ...
        <div class="flex flex-1">
            ...
            <div class="flex-1 flex flex-col overflow-hidden ml-0 md:ml-64">
                ...
                <div>
                    ...
                    <div class="bg-red-100 border border-red-400 text-red-700 text-sm p-2 rounded mb-4">
                    ...
                    <div class="bg-green-300 border border-green-600 text-black text-sm p-2 rounded mb-4">
                    ...
                    @endif -->
                        ...
                        <div id="updatePasswordView">
                            ...
                            <form
                                ...
                                <div id="updatePasswordModal" class="fixed inset-0 bg-black bg-opacity-50  flex  hidden items-center justify-center ">
